      ...
      <nav className="w-full bg-white px-6 py-4 flex items-center justify-between shadow-sm">
        ...
        <div className="flex items-center">
          <div className="w-8 h-8 rounded-full bg-[var(--tag-color)] flex items-center justify-center mr-2">
            <span className="text-[var(--main-color)] text-lg font-bold font-[var(--content-font-family)]">?</span>
          </div>
        ...
        <div className="hidden md:flex items-center space-x-8">
          {['about', 'features', 'meet-emmo', 'contact'].map((item) => (
            <a
              key={item}
              href={`#${item}`}
        ...
        {/* CTA Button - Desktop */}
        <a href="#waitlist">
          <button className="hidden md:block bg-[var(--main-color)] text-white px-6 py-2 rounded-full font-medium hover:bg-purple-700 transition font-[var(--content-font-family)] text-[var(--button-font-size)]">
            Join Waitlist
          </button>
        </a>
      ...
      {isMenuOpen && (
        <div className="md:hidden w-full bg-white shadow-md py-3 z-20 absolute">
          <div className="flex flex-col space-y-3 px-6">
            {['about', 'features', 'meetEmmo', 'contact'].map((item) => (
              <a
                key={item}
                href={`#${item}`}
            ...
            <div className="py-3">
              <a href="mailto:abc@gmail.com">
                <button className="bg-[var(--main-color)] text-white px-4 py-2 rounded-full font-medium hover:bg-purple-700 transition w-full font-[var(--content-font-family)] text-[var(--button-font-size)]">
                  Join Waitlist
                </button>
              </a>
            </div>
