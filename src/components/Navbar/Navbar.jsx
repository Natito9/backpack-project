  ...
  return (
    <div className="w-full">
      <nav className="w-full bg-white px-6 py-4 flex items-center justify-between shadow-sm">
        ...
        {/* CTA Button - Desktop */}
        <a href="#waitlist">
        <button className="hidden md:block bg-[var(--main-color)] text-[var(--text-color)] px-6 py-2 rounded-full font-medium hover:bg-[#cceaea] transition font-[var(--content-font-family)] text-[var(--button-font-size)]">
  Join Waitlist
</button>
