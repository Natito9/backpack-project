...
export default function Mission() {
  return (
    <section id="mission" className="flex flex-col justify-center items-center py-10 px-5 md:py-20">
      ...
      Parenting in the digital age is tough. We want to guide our kids - but end up in conflict, becoming screen police instead of just being present. Algorithms are smart, and we're always one step behind.



      </p>
      <p className="text-center pb-12">Backpack is here to change that. A helping hand on the phone, right in the moment - gently nudging, setting boundaries, and supporting healthy choices. So parents can focus on what really matters: strong, loving relationships.</p>
