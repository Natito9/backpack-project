export default function ChatBubble() {
  return (
    <div className="absolute bottom-[22rem] right-4 md:bottom-[22rem]  lg:right-[7rem] p-4">
      <aside
        role="status"
        aria-live="polite"
      ...
      >
        ...
        <div className="absolute left-[15rem]  -bottom-1 w-4 h-4 bg-white rotate-30 "></div>
      </aside>
    </div>
  );
}
