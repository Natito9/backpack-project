...
export default function ChatBubble() {
  return (
    <section className="relative h-screen">
      <div
        className="absolute top-[45%] left-[40%] md:top-[55%] md:left-[32%] lg:top-[50%] lg:left-[43%] -translate-x-1/2 -translate-y-1/2 z-50 transition-all duration-300 ease-in-out hide-on-small-height"
        style={{
