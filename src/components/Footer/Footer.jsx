      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col space-y-2">
            ...
            <a href="#" className="text-gray-600 text-sm hover:bg-[#cceaea] rounded-full px-2 py-1">About</a>
            <a href="#" className="text-gray-600 text-sm hover:bg-[#cceaea] rounded-full px-2 py-1">Features</a>
            <a href="#" className="text-gray-600 text-sm hover:bg-[#cceaea] rounded-full px-2 py-1">Meet Emmo</a>
          </div>
